...
const MovieCard = ({ movie }: MovieCardProps) => {
  ...
  return (
    ...
    hover:-translate-y-1 transition duration-300 w-70'>
        ...
        <div className="flex items-center justify-between mt-4 pb-3">
            <button onClick={()=>{navigate(`/movies/${movie.id}`); scrollTo(0,0);}} className="px-4 py-2 text-xs bg-primary hover:bg-primary-dull
